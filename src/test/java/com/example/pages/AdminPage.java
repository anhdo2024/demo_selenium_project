...
public class AdminPage {
    ...
    private final By searchButton = By.xpath("//button[contains(@class,'oxd-button') and normalize-space()='Search']");
    private final By resetButton = By.xpath("//button[contains(@class,'oxd-button') and normalize-space()='Reset']");
